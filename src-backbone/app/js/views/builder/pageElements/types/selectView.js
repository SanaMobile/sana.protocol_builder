...
module.exports = Marionette.LayoutView.extend({
    ...
    template: require('templates/builder/pageElements/types/selectView'),
    ...
    onBeforeShow: function() {
        ...
        this.showChildView('choicesList', this.choicesCollectionView);
    },
    ...
    _onKeypressNewChoiceInput: function(event) {
        ...
        let newChoice = this.model.createNewChoice(String.fromCharCode(event.keyCode));
    ...
    _onPasteNewChoiceInput: function(event) {
        ...
        let newChoice = this.model.createNewChoice(strippedText);
        this._changeFocusToNewChoice(newChoice);
    },
