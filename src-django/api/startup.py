...
from models import Procedure, Page, Element, AbstractElement, Concept, ShowIf, MDSInstance
...
def grant_permissions():
    ...
    models = [Procedure, Page, Element, AbstractElement, Concept, ShowIf, User, MDSInstance]
